...
> ⚠️ **교육·연구용입니다. 투자 권유가 아닙니다.** 백테스트 검증 결과, 핵심 전략(**국면틸트**: 좋은 국면엔 고베타 QQQ 풀투자, 나쁜 국면엔 방어)은 *수익과 방어를 동시에* — buy-hold 수익에 근접(CAGR 10.2 vs 11.1%)하면서 최대낙폭은 -15%p 낮습니다(-36% vs -51%). 단독 매매신호로 쓰지 말고 전술적 자산배분(TAA)의 비중·고베타 다이얼로 사용하세요.
